    ...
    inputSchema: {
      ...
      properties: {
        ...
        includeFiles: {
          ...
          description: 'Files to include. Use ["*"] for ALL source files (filtered by .contextignore). Or specific files: ["parser.js", "tools.js"]'
        },
        includeDocs: {
          type: "boolean",
          description: "Include doc-dialect documentation (default: true, auto-disabled with '*')"
        },
        includeSkeleton: {
          type: "boolean",
          description: "Include project skeleton (default: true, auto-disabled with '*')"
        }
      },
      required: [ "path" ]
    }
...
export const TOOLS = [ e.get_skeleton, e.get_focus_zone, e.get_ai_context, e.invalidate_cache, e.get_usage_guide, e.get_agent_instructions, e.get_custom_rules, e.set_custom_rule, e.check_custom_rules, e.get_framework_reference, {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      symbol: {
        type: "string",
        description: "Symbol name (for expand, deps, usages)"
      },
      from: {
        type: "string",
        description: "Starting symbol (for call_chain)"
      },
      to: {
        type: "string",
        description: "Target symbol (for call_chain)"
      },
      path: {
        type: "string",
        description: "Path to scan (for call_chain, sub_projects)"
      }
    },
    required: [ "action" ]
  }
  ...
  inputSchema: {
    ...
    properties: {
      action: {
        type: "string",
        enum: [ "dead_code", "similar_functions", "complexity", "large_files", "outdated_patterns", "full_analysis", "analysis_summary", "undocumented" ],
      ...
      minComplexity: {
        type: "number",
        description: "For complexity: minimum threshold (default: 1)"
      },
      onlyProblematic: {
        type: "boolean",
        description: "For complexity/large_files: only show issues"
      },
      threshold: {
        type: "number",
        description: "For similar_functions: min similarity % (default: 60)"
      },
      includeItems: {
        type: "boolean",
        description: "For full_analysis: include individual items"
      },
      level: {
        type: "string",
        enum: [ "tests", "params", "all" ],
        description: "For undocumented: strictness level"
      },
      codeOnly: {
        type: "boolean",
        description: "For outdated_patterns: only check code"
      },
      depsOnly: {
        type: "boolean",
        description: "For outdated_patterns: only check deps"
      }
    },
  ...
  inputSchema: {
    ...
    properties: {
      ...
      path: {
        type: "string",
        description: "Path to scan (for pending, summary)"
      },
      testId: {
        type: "string",
        description: "Test ID (for pass, fail)"
      },
      reason: {
        type: "string",
  ...
  inputSchema: {
    ...
    properties: {
      ...
      excludeDirs: {
        ...
        description: "For set: directories to exclude"
      },
      excludePatterns: {
        type: "array",
        items: {
        ...
        description: "For set: file patterns to exclude"
      },
      useGitignore: {
        type: "boolean",
        description: "For set: use .gitignore patterns"
      },
      includeHidden: {
        type: "boolean",
        description: "For set: include hidden directories"
      },
      dirs: {
        type: "array",
        items: {
        ...
        description: "For add_excludes/remove_excludes"
      }
    },
    required: [ "action" ]
  }
  ...
  inputSchema: {
    ...
    properties: {
      ...
      name: {
        type: "string",
        description: "For generate: specific function name"
      },
      files: {
        type: "array",
        items: {
        ...
        description: "For check_types: specific files"
      },
      maxDiagnostics: {
        type: "number",
        description: "For check_types: max diagnostics (default: 50)"
      }
    },
    required: [ "action", "path" ]
  }
  ...
  inputSchema: {
    ...
    properties: {
      ...
      file: {
        type: "string",
        description: "For get: specific file docs"
      },
      overwrite: {
        type: "boolean",
        description: "For generate: overwrite existing (merge preserves descriptions)"
      },
      scope: {
        description: 'For generate: "all", "focus" (git diff), or array of file paths'
      },
      strict: {
        type: "boolean",
        description: "For validate_contracts: report functions missing from .ctx"
      }
    },
    required: [ "action", "path" ]
  }
  ...
  name: "compact",
  description: "Compact code operations. Actions: compact_file|edit|compact_all|beautify|expand_file|expand_project|validate_pipeline|get_mode|set_mode",
  inputSchema: {
    type: "object",
    properties: {
      action: {
        type: "string",
        enum: [ "compact_file", "edit", "compact_all", "beautify", "expand_file", "expand_project", "validate_pipeline", "get_mode", "set_mode" ],
      ...
      symbol: {
        type: "string",
        description: "For edit: function/class name to replace"
      },
      code: {
        type: "string",
        description: "For edit: new code for the symbol"
      },
      beautify: {
        type: "boolean",
        description: "Beautify output (default: true)"
      },
      legend: {
        type: "boolean",
        description: "For compact_file: include export legend"
      },
      dryRun: {
        type: "boolean",
      ...
      mode: {
        type: "number",
        description: "For set_mode: 1 (compact, recommended) or 2 (full)"
      },
      autoValidate: {
        type: "boolean",
        description: "For set_mode: auto-validate after edits"
      },
      stripJSDoc: {
        type: "boolean",
        description: "For set_mode: strip JSDoc when compacting"
      },
      strict: {
        type: "boolean",
        description: "For validate_pipeline: report fns missing from .ctx"
      },
      fix: {
        type: "boolean",
        description: "For validate_pipeline: auto-fix all style issues — generates .ctx documentation from readable code, then minifies (headers, imports, indentation, long names). Bidirectional: expand restores from .ctx."
      }
    },
    required: [ "action" ]
  }
  ...
  inputSchema: {
    ...
    properties: {
      ...
      table: {
        type: "string",
        description: "For table_usage: filter to specific table"
      }
    },
    required: [ "action", "path" ]
  }
